...
public class PascalTriangle {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Row 4: " + java.util.Arrays.toString(row4)); // Expected output: [1, 4, 6, 4, 1]

    //            int[] row5 = triangleRow(-5);
    //            System.out.println("Row 5: " + java.util.Arrays.toString(row5));
    // //StackOverflowError

    int[] row100 = triangleRow(100);
    System.out.println(
        "Row 100: " + java.util.Arrays.toString(row100)); // Use BigInteger to handle large numbers
  }
}
