...
public class ReverseAnArray {
    ...
    //5. Inside the while loop, create a variable called temp and set it to the value of the array at the index of end
    //6. Inside the while loop, set the value of the array at the index of end to the value of the array at the index of start
